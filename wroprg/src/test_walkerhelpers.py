...
def test_equidistance_walk_func1():
    ...
    angle = walker.walk_func(left_distance,right_distance, 0)
    assert angle is None

    # Simulate a scenario where the left distance is less than the default
    angle = walker.walk_func(left_distance-5, right_distance+5, 0)
    ...
    angle = walker.walk_func(left_distance+1, right_distance-1, 0)

    angle = walker.walk_func(left_distance+2, right_distance-2, 0)

    angle = walker.walk_func(left_distance+2.5, right_distance-2.5, 0)
...
def test_equidistance_walk_func2():
    ...
    angle = walker.walk_func(def_distance_left,def_distance_right, 0)
    assert angle is None

    # Simulate a scenario where the left distance is less than the default
    angle = walker.walk_func(def_distance_left-5, def_distance_right, 0)

    assert angle is not None
    assert angle > 0.0  # Expect a positive angle since right distance is increased

    # Simulate a scenario where the right distance is less than the default
    angle = walker.walk_func(def_distance_left+1, def_distance_right, 0)

    angle = walker.walk_func(def_distance_left+2, def_distance_right, 0)

    angle = walker.walk_func(def_distance_left+2.5, def_distance_right, 0)
...
def test_equidistance_walk_func3():
    ...
    # Simulate a scenario where the left distance is less than the default
    angle = walker.walk_func(def_distance_left, def_distance_right+5, 0)

    assert angle is not None
    assert angle > 0.0  # Expect a positive angle since right distance is increased

    # Simulate a scenario where the right distance is less than the default
    angle = walker.walk_func(def_distance_left, def_distance_right-1, 0)

    angle = walker.walk_func(def_distance_left, def_distance_right-2, 0)

    angle = walker.walk_func(def_distance_left, def_distance_right-2.5, 0)
